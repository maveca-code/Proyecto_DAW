<?php
    ...
    //funcion que calcula el numero de dias en la semana
    function calcula_numero_dia_semana($dia,$mes,$ano){
	$numerodiasemana = date('w', mktime(0,0,0,$mes,$dia,$ano));//con mktime obtengo el tiempo en Unix de una fecha
    ...
    }//fin funcion numero dias en la semana
    
    //funcion que devuelve el último día de un mes y año dados
    function ultimoDia($mes,$ano){ 
        $ultimo_dia=28; 
        while (checkdate($mes,$ultimo_dia + 1,$ano)){ //con checkdate valido una fecha gregoriana
            $ultimo_dia++; 
        } 
        return $ultimo_dia; 
    }//fin funcion devuelve ultimo dia y año 
    
    //funcion que nos da el nombre del mes
	...
	return $nombre_mes;
    }//fin funcion nombre del mes
    
    //funcion para poner estilo segun el dia
	...
	echo "<a style=color:white;text-decoration:none href=../../vista/calendario/calendario.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
	...
	echo "<a style=color:white;text-decoration:none href=../../vista/calendario/calendario.php?$parametros_formulario&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente>&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
	...
	echo "</tr>";
	echo "</table>";
    }//fin funcion mostrar calendario	
    
    function formularioCalendario($mes,$ano){
	global $parametros_formulario;
    echo '<br><table align="center" cellspacing="2" cellpadding="2" border="0" class=tform>
            <tr><form action="../../vista/calendario/calendario.php?' . $parametros_formulario . '" method="POST">';
    echo '
    ...
    }//fin funcion formulario calendario
