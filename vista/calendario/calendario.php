<html>
    ...
    Para que este calendario pueda actualizar los campos de formulario correctos debe recibir varios datos (por GET) formulario (con el nombre del formulario donde estan los campos 
    dia (con el nombre del campo donde se colocará el día) mes (con el nombre del campo donde se colocará el mes) ano (con el nombre del campo donde se colocará el año)-->
    <head>
    ...
    ?>
        <div align="center">
        <?php
            require ("../../controlador/funciones_calendario.php");
            $tiempo_actual = time();
